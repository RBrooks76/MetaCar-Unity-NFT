            ...
            require: function(e) {
                var t = {
                    ...
                    "zlib/inflate.js": function(e, t, r) {
                        ...
                        function i(e) {
                            var t;
                            return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = P, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new p.Buf32(ge), t.distcode = t.distdyn = new p.Buf32(me), t.sane = 1, t.back = -1, T) : A
                        }
                        ...
                        function l(e, t) {
                            var r, n;
                            return e ? (n = new o, e.state = n, n.window = null, r = s(e, t), r !== T && (e.state = null), r) : A
                        }
                        ...
                        function c(e, t) {
                            ...
                            r = e.state, r.mode === Y && (r.mode = q), s = e.next_out, i = e.output, d = e.avail_out, a = e.next_in, o = e.input, l = e.avail_in, c = r.hold, h = r.bits, b = l, g = d, xe = T;
                            e: for (;;) switch (r.mode) {
                                case P:
                                    if (0 === r.wrap) {
                                        r.mode = q;
                                    ...
                                    r.dmax = 1 << _e, e.adler = r.check = 1, r.mode = 512 & c ? K : Y, c = 0, h = 0;
                                    break;
                                case N:
                                    for (; h < 16;) {
                                        if (0 === l) break e;
                                ...
                                case ne:
                                    if (l >= 6 && d >= 258) {
                                        e.next_out = s, e.avail_out = d, e.next_in = a, e.avail_in = l, r.hold = c, r.bits = h, y(e, g), s = e.next_out, i = e.output, d = e.avail_out, a = e.next_in, o = e.input, l = e.avail_in, c = r.hold, h = r.bits, r.mode === Y && (r.back = -1);
                                        break
                                    }
                        ...
                        function b(e, t) {
                            var r;
                            return e && e.state ? (r = e.state, 0 === (2 & r.wrap) ? A : (r.head = t, t.done = !1, T)) : A
                        }

                        function g(e, t) {
                            var r, n, o, i = t.length;
                            return e && e.state ? (r = e.state, 0 !== r.wrap && r.mode !== V ? A : r.mode === V && (n = 1, n = v(n, t, i, 0), n !== r.check) ? O : (o = u(e, t, i, i)) ? (r.mode = he, I) : (r.havedict = 1, T)) : A
                        }
                    ...
                    "zlib/inftrees.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, b, g, m, w, p) {
                            ...
                            for (R = 1; R < A && 0 === D[R]; R++);
                            for (O < R && (O = R), F = 1, T = 1; T <= o; T++)
                                if (F <<= 1, F -= D[T], F < 0) return -1;
                            if (F > 0 && (e === s || 1 !== A)) return -1;
                            for (j[1] = 0, T = 1; T < o; T++) j[T + 1] = j[T] + D[T];
                            for (L = 0; L < b; L++) 0 !== t[r + L] && (w[j[t[r + L]]++] = L);
                            if (e === s ? (Z = M = w, S = 19) : e === l ? (Z = f, H -= 257, M = u, W -= 257, S = 256) : (Z = c, M = h, S = -1), N = 0, L = 0, T = R, x = m, I = O, z = 0, y = -1, P = 1 << O, _ = P - 1, e === l && P > i || e === d && P > a) return 1;
                            for (;;) {
                                E = T - z, w[L] < S ? (C = 0, U = w[L]) : w[L] > S ? (C = M[W + w[L]], U = Z[H + w[L]]) : (C = 96, U = 0), v = 1 << T - z, k = 1 << I, R = k;
                                do k -= v, g[x + (N >> z) + k] = E << 24 | C << 16 | U | 0; while (0 !== k);
                                for (v = 1 << T - 1; N & v;) v >>= 1;
                                if (0 !== v ? (N &= v - 1, N += v) : N = 0, L++, 0 === --D[T]) {
                                    if (T === A) break;
                                    T = t[r + w[L]]
                                }
                                if (T > O && (N & _) !== y) {
                                    for (0 === z && (z = O), x += R, I = T - z, F = 1 << I; I + z < A && (F -= D[I + z], !(F <= 0));) I++, F <<= 1;
                                    if (P += 1 << I, e === l && P > i || e === d && P > a) return 1;
                                    y = N & _, g[y] = O << 24 | I << 16 | x - m | 0
                                }
                            }
                            return 0 !== N && (g[x + N] = T - z << 24 | 64 << 16 | 0), p.bits = O, 0
                        }
                    }
                };
